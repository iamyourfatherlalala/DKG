...
class SchemeQueryByConcept extends Component {
    ...
    getRelationsByConcept() {
        ...
        let url = `http://106.14.134.97:8079/DKGBackend/relation/${inputConcept}`;
    ...
    onDeleteRow(row) {            
        ...
        console.log(data_remained);  /////////////////////////////////////////////////////////
        let proxyurl = "https://cors-anywhere.herokuapp.com/";  // could add Headers instead
        let url = `http://106.14.134.97:8079/DKGBackend/relation/${temp.FROMCONCEPT}/${temp.RELATION}/${temp.TOCONCEPT}`;
